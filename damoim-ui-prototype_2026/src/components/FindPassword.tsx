            ...
            <div className="login-brand" onClick={() => navigate('/login')} style={{ cursor: 'pointer' }}>
              <span className="login-brand-icon">
                <svg width="28" height="28" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <defs><linearGradient id="findPwLogoGrad" x1="0" y1="0" x2="100" y2="100" gradientUnits="userSpaceOnUse"><stop stopColor="#32373c"/><stop offset="1" stopColor="#1a1d20"/></linearGradient></defs>
              ...
              {step === 'reset' && (
                <form className="login-card-body" onSubmit={handleResetPassword}>
                  <div style={{
                    ...
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#32373c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
