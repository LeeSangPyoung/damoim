...
export default function ClassmateList() {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case '초등학교': return { bg: '#f59e0b', color: 'white', border: '#f59e0b' };
      case '중학교': return { bg: '#f59e0b', color: 'white', border: '#f59e0b' };
      case '고등학교': return { bg: '#f59e0b', color: 'white', border: '#f59e0b' };
      default: return { bg: '#f59e0b', color: 'white', border: '#f59e0b' };
    }
  };
